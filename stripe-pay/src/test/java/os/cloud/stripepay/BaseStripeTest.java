...
public class BaseStripeTest {
    ...
    public static void checkStripeMock() throws Exception {
        ...
        URL url = new URL(String.format("http://39.105.194.192:%s", port));
    ...
    public void setUpStripeMockUsage() {
        ...
        Stripe.overrideApiBase("http://39.105.194.192:" + port);
        Stripe.overrideUploadBase("http://39.105.194.192:" + port);
    ...
    protected static String getFixture(String path, String[] expansions) throws Exception {
        ...
        urlStringBuilder.append("http://39.105.194.192:" + port + path);
